...
public class myDateChooser extends JPanel{
    ...
    private String showDate;//,toSelect;
     ...
     */
    public myDateChooser(Component owner) {
        initDate=new Date();
 ...
 /**
    ...
    //提交日期
    private void commit(){
        showDate=sdf.format(select.getTime());
        System.out.println("选中的日期是："+showDate);
        hidePanel();
        //在owner中更新值
        try{
            JTextField temp=(JTextField)owner;
            temp.setText(showDate);
        }catch(Exception e){
            System.out.println("owner 不可调用setText");
        }
    }
    ...
    private class JP4 extends JPanel{
     ...
     public static void main(String[] args) {
        ...
        final myDateChooser dc=new myDateChooser(null); 
    }
}
